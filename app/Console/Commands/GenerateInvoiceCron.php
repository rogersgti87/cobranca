...
//     $sqlCreateInvoice = "SELECT i.id, i.user_id, i.gateway_payment, i.payment_method, i.description, i.price, i.status, c.type,
//     c.name customer, c.email, c.email2, c.phone, c.notification_whatsapp, c.notification_email, c.company
//     FROM invoices i
//     INNER JOIN customers c ON i.customer_id = c.id
//     where i.status = 'Pendente' and gateway_payment <> 'Estabelecimento' and transaction_id is null limit 10";

//         $createInvoices = DB::select($sqlCreateInvoice);
