...
class GenerateInvoiceCron extends Command
{
  ...
  public function handle()
  {
    ...
    AND DATE_ADD(CONCAT(YEAR(CURRENT_DATE),'-',MONTH(CURRENT_DATE),'-',a.day_due), INTERVAL 0 MONTH) =  DATE_ADD(DATE_ADD(CONCAT(YEAR(CURRENT_DATE),'-',MONTH(CURRENT_DATE),'-','13'), INTERVAL 0 MONTH), INTERVAL 0 DAY)
