                ...
                success:function(data){
                    ...
                    $.each(data, function(i, item) {
                        ...
                        html += `<td>
                            ...
                            ${item.status == 'Pendente' || item.status == 'Erro' ? '<a href="#" data-original-title="Cancelar Fatura" id="btn-delete-invoice" data-placement="left" data-invoice="'+item.id+'" data-tt="tooltip" class="btn btn-danger btn-xs"> <i class="fas fa-undo-alt"></i></a>' : ''}
