...
<div class="content-wrapper">
    ...
    <div class="modern-header">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1>👥 Clientes</h1>
                <p style="margin: 5px 0 0; opacity: 0.9; font-size: 14px;">Gerencie seus clientes</p>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="bulk-actions" id="bulk-actions">
            <div>
                <span class="selected-count"><span id="selected-count">0</span> cliente(s) selecionado(s)</span>
            </div>
            <div>
                        ...
                        @forelse($data as $result)
                            <tr>
                                ...
                                <td>
                                    @php
                                        $hasImage = false;
                                        if (isset($result->image) && $result->image && file_exists(public_path($result->image))) {
                                            $hasImage = true;
                                        }
                                    @endphp
                                    @if($hasImage)
...
$(document).ready(function() {
    ...
    function applyFilters(showLoading = true) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                const $newContent = $(response).find('#customers-tbody');
    ...
    function changeInputType() {
        ...
        // Reativar eventos (debounce 500ms)
    ...
    $('#btn-bulk-delete').on('click', function() {
        ...
        Swal.fire({
            title: 'Deseja remover os clientes selecionados?',
            text: `${selected.length} cliente(s) será(ão) removido(s)!`,
            icon: 'question',
