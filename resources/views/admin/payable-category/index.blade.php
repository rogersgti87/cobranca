        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <a href="#" data-original-title="Nova Categoria" id="btn-modal-category" data-type="add-category" data-toggle="tooltip" class="btn" style="background-color: #D4AF37; color: #FFFFFF !important; border: none; padding: 10px 20px; border-radius: 6px; font-weight: 600; transition: all 0.3s;"> <i class="fa fa-plus"></i> Nova Categoria</a>
                </div>
            </div>
        ...
        <div class="modal-content" style="background-color: #111827; border: 1px solid rgba(255,255,255,0.1);">
            <form action="" class="form-horizontal" id="form-request-category">
                <div class="modal-header" style="background-color: #1E293B; border-bottom: 1px solid rgba(255,255,255,0.1);">
                    <h5 class="modal-title" id="modalCategoryLabel" style="color: #D4AF37; font-weight: 600;"></h5>
    ...
    $(document).on('click', '#btn-save-category', function(e) {
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                var titleHtml = "<h5 style='color:#D4AF37'>" + data.data + "</h5>";
                Swal.fire({
                    width: 350,
                    title: titleHtml,
                    icon: 'success',
