        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right" style="background-color: transparent; padding: 0;">
              ...
              <li class="breadcrumb-item active" style="color: #F0F0F2; opacity: 0.7;">Contas a receber</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
         ...
         <div class="row">
                ...
                <div style="background-color: #1A1A20; border: 1px solid rgba(0,0,0,0.1); border-radius: 8px; padding: 20px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <div>
                            ...
                            <p id="total_count" style="color: #F0F0F2; font-size: 12px; margin: 5px 0 0 0; opacity: 0.6;">0 faturas</p>
                        </div>
                ...
                <div style="background-color: #1A1A20; border: 1px solid rgba(0,0,0,0.1); border-radius: 8px; padding: 20px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <div>
                            ...
                            <p id="pendente_count" style="color: #F0F0F2; font-size: 12px; margin: 5px 0 0 0; opacity: 0.6;">0 faturas</p>
                        </div>
                        <div style="width: 48px; height: 48px; background-color: rgba(212, 175, 55,0.2); border-radius: 8px; display: flex; align-items: center; justify-content: center;">
            ...
            <div class="col-md-3 col-6 mb-3">
                <div style="background-color: #1A1A20; border: 1px solid rgba(0,0,0,0.1); border-radius: 8px; padding: 20px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <div>
                            <p style="color: #F0F0F2; font-size: 14px; margin: 0; font-weight: 500; opacity: 0.7;">Recebidas</p>
                            <h5 id="pago_currency" style="color: #22C55E; font-size: 20px; font-weight: 600; margin: 5px 0 0 0;">R$0,00</h5>
                            <p id="pago_count" style="color: #F0F0F2; font-size: 12px; margin: 5px 0 0 0; opacity: 0.6;">0 faturas</p>
                        </div>
                ...
                <div style="background-color: #1A1A20; border: 1px solid rgba(0,0,0,0.1); border-radius: 8px; padding: 20px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <div>
                            ...
                            <p id="cancelado_count" style="color: #F0F0F2; font-size: 12px; margin: 5px 0 0 0; opacity: 0.6;">0 faturas</p>
                        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="collapse mb-4" id="filtersCollapse">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <fieldset style="border: 1px solid rgba(212, 175, 55,0.5); border-radius: 8px; padding: 15px; margin: 0; background-color: #1A1A20; position: relative;">
                                <legend style="color: #D4AF37; font-size: 14px; font-weight: 600; padding: 0 10px; margin: 0; border: none;">Forma de Pagamento</legend>
                ...
                <div class="form-group col-md-12 mt-3">
                    <label style="color: #F0F0F2; font-weight: 500; font-size: 14px; margin-bottom: 8px;">Clientes</label>
            ...
            <div class="table-responsive">
                <table class="table" id="report-table" style="margin-bottom: 0;">
                    ...
                    <tr style="border-bottom: 2px solid rgba(0,0,0,0.1);">
                        ...
                        <th style="color: #F0F0F2; font-weight: 600; padding: 12px; border: none; font-size: 14px;">Cliente</th>
                        <th style="color: #F0F0F2; font-weight: 600; padding: 12px; border: none; font-size: 14px;">Descrição</th>
                        <th style="color: #F0F0F2; font-weight: 600; padding: 12px; border: none; font-size: 14px;">Serviço</th>
                        <th style="color: #F0F0F2; font-weight: 600; padding: 12px; border: none; font-size: 14px;">Vencimento</th>
                        <th style="color: #F0F0F2; font-weight: 600; padding: 12px; border: none; font-size: 14px;">Recebido em</th>
...
function displayReport(data, totals) {
    ...
    if(data.length === 0) {
        ...
        data.forEach(function(item, index) {
            const statusColor = item.status === 'Pago' ? '#22C55E' : item.status === 'Pendente' ? '#D4AF37' : item.status === 'Expirado' ? '#F59E0B' : '#F87171';
