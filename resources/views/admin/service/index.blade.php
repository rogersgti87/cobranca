        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <ul class="button-action">
                <li><a href="{{url($linkFormAdd)}}" data-original-title="Novo" data-toggle="tooltip" class="btn btn-sm" style="background-color: #D4AF37; color: #FFFFFF !important; border: none; padding: 8px 12px; border-radius: 6px; font-weight: 600;"> <i class="fa fa-plus"></i> Novo</a></li>
                        ...
                        <form class="form">
                            ...
                            @foreach($data as $result)
                                <tr>
                                    ...
                                    <td><a href="{{url($linkFormEdit."&id=$result->id")}}" data-original-title="Editar" data-toggle="tooltip" class="btn btn-xs" style="background-color: #D4AF37; color: #FFFFFF !important; border: none; padding: 4px 8px; border-radius: 4px; font-weight: 600;"> <i class="fa fa-list"></i> Editar</a></td>
                                </tr>
                            @endforeach
                        </form>
                        </tbody>
