        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <ul class="button-action">
                <li><a href="#" data-original-title="Novo" id="btn-modal-supplier" data-type="add-supplier" data-toggle="tooltip" class="btn btn-sm" style="background-color: #D4AF37; color: #FFFFFF !important; border: none; padding: 8px 12px; border-radius: 6px; font-weight: 600;"> <i class="fa fa-plus"></i> Novo</a></li>
             </ul>
          </div>
                        ...
                        <form class="form">
                            ...
                            @foreach($data as $result)
                                <tr>
                                    ...
                                    <td><a href="#" data-original-title="Editar" id="btn-modal-supplier" data-type="edit-supplier" data-supplier="{{$result->id}}" data-toggle="tooltip" class="btn btn-xs" style="background-color: #D4AF37; color: #FFFFFF !important; border: none; padding: 4px 8px; border-radius: 4px; font-weight: 600;"> <i class="fa fa-list"></i> Editar</a></td>
                                </tr>
                            @endforeach
                        </form>
                        </tbody>
        ...
        <div class="modal-content" style="background-color: #111827; border: 1px solid rgba(255,255,255,0.1);">
            <form action="" class="form-horizontal" id="form-request-supplier">
                <div class="modal-header" style="background-color: #1E293B; border-bottom: 1px solid rgba(255,255,255,0.1);">
                    <h5 class="modal-title" id="modalSupplierLabel" style="color: #D4AF37; font-weight: 600;"></h5>
